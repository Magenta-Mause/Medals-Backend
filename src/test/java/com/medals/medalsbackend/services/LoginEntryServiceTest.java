...
public class LoginEntryServiceTest {
  ...
  public void testPasswordReset() {
    ...
    loginEntryService.createLoginEntry("admin@example.org", OneTimeCodeCreationReason.ACCOUNT_CREATED, "system");
  ...
  public void testLoginEntryCreationTriggersEmailSending() {
    ...
    loginEntryService.createLoginEntry("test@gmail.com", OneTimeCodeCreationReason.ACCOUNT_CREATED, "system");
    verify(oneTimeCodeService, times(1)).createSetPasswordToken(eq("test@gmail.com"), eq(OneTimeCodeCreationReason.ACCOUNT_CREATED), eq("system"));
  }
